...
gint midi_control = 1;
gint midi_map[0x7f][0x10];

static gint width = 0;

#define MAX_MODE 0 /* fixme */
#define MAX_FLAGS 0 /* fixme */

static int flags = 0;
static int mode = 0;
static int midi_vals[0xfff][2]; /* fixme */

gint 
b_midi_open (gint _width) 
{
  int fd;
...
void 
b_midi_install_default_map (void) 
{
  int x, c;
