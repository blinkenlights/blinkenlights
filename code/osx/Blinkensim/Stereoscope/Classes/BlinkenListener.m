...
- (NSString *)description {
	return [NSString stringWithFormat:@"<%@ %p, screenID:%d maxValue:%d size:%@ bpp:%d dataLength:%u>",NSStringFromClass([self class]),self,self.screenID, self.maxValue, NSStringFromCGSize(self.frameSize), self.bitsPerPixel, self.frameData.length];
}
