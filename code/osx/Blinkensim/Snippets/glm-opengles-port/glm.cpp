...
glmDraw(GLMmodel* model, GLuint mode)
{
    ...
    while (group) {
        ...
        if (mode & GLM_COLOR) {
            ...
            const GLfloat *v = material->diffuse;
            glColor4f(v[0],v[1],v[2],1.0);
        }
        
        //glBegin(GL_TRIANGLES);
        GLfloat triangles[(group->numtriangles+1)*9];
        GLfloat normals[(group->numtriangles+1)*9];
        GLfloat textures[(group->numtriangles+1)*9];
        for (i = 0; i < group->numtriangles; i++) {
            ...
            {
                GLfloat *v;
                v = &model->facetnorms[3 * triangle->findex];                
                normals[i*9+0] = v[0];
                normals[i*9+1] = v[1];
                normals[i*9+2] = v[2];
                normals[i*9+3] = v[0];
            ...
            {
                GLfloat *v;
                v = &model->normals[3 * triangle->nindices[0]];
                normals[i*9+0] = v[0];
                normals[i*9+1] = v[1];
                normals[i*9+2] = v[2];
                v = &model->normals[3 * triangle->nindices[1]];
                normals[i*9+3] = v[0];
                normals[i*9+4] = v[1];
                normals[i*9+5] = v[2];
                v = &model->normals[3 * triangle->nindices[2]];
                normals[i*9+6] = v[0];
                normals[i*9+7] = v[1];
                normals[i*9+8] = v[2];
            }
            ...
            {
                GLfloat *v;
                v = &model->texcoords[2 * triangle->tindices[0]];
                textures[i*9+0] = v[0];
                textures[i*9+1] = v[1];
                textures[i*9+2] = v[2];
                v = &model->texcoords[2 * triangle->tindices[1]];
                textures[i*9+3] = v[0];
                textures[i*9+4] = v[1];
                textures[i*9+5] = v[2];
                v = &model->texcoords[2 * triangle->tindices[2]];
                textures[i*9+6] = v[0];
                textures[i*9+7] = v[1];
                textures[i*9+8] = v[2];
            ...
            v = &model->vertices[3 * triangle->vindices[0]];
            triangles[i*9+0] = v[0];
            triangles[i*9+1] = v[1];
            triangles[i*9+2] = v[2];
            v = &model->vertices[3 * triangle->vindices[1]];
            triangles[i*9+3] = v[0];
            triangles[i*9+4] = v[1];
            triangles[i*9+5] = v[2];
            v = &model->vertices[3 * triangle->vindices[2]];
            triangles[i*9+6] = v[0];
            triangles[i*9+7] = v[1];
            triangles[i*9+8] = v[2];
