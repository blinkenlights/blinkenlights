...
#import "BlinkenConsumingSenderPlugIn.h"
#import "BlinkenImageProvider.h"

#define	kQCPlugIn_Name				@"Blinkensender (consumer)"
#define	kQCPlugIn_Description		@"This plugin sends the input image as Blinkenframes to a destination."



@implementation BlinkenConsumingSenderPlugIn
