...
#define emacETHADDR1 0x11
#define emacETHADDR2 0x22
#define emacETHADDR3 0x33
#define emacETHADDR4 0x44
#define emacETHADDR5 0x55

/* The IP address being used. */
#define emacIPADDR0 0
#define emacIPADDR1 0
#define emacIPADDR2 0
#define emacIPADDR3 0

/* The gateway address being used. */
#define emacGATEWAY_ADDR0 0
#define emacGATEWAY_ADDR1 0
#define emacGATEWAY_ADDR2 0
#define emacGATEWAY_ADDR3 0

/* The network mask being used. */
#define emacNET_MASK0 0
#define emacNET_MASK1 0
